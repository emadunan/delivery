# Generated by Django 3.1.7 on 2021-05-02 18:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(related_name='orders', through='delivery.OrderItem', to='delivery.Item'),
        ),
        migrations.AddField(
            model_name='order',
            name='user_client',
        ...
        migrations.AddField(
            model_name='order',
            name='user_delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_orders', to=settings.AUTH_USER_MODEL),
        ),
    ]
